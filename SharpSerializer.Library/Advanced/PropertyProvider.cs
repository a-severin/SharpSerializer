...
namespace Serialization.Advanced {
	...
	public class PropertyProvider {
		...
		///     If they are parts of your own business objects, you can mark these properties with
		...
		public IList<PropertyInfo> GetProperties(TypeInfo typeInfo) {
			// Search in cache
			IList<PropertyInfo> propertyInfos = Cache.TryGetPropertyInfos(typeInfo.Type);
